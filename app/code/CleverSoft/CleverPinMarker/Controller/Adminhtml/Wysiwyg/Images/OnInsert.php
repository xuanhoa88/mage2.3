 ...
 */
namespace CleverSoft\CleverPinMarker\Controller\Adminhtml\Wysiwyg\Images;
...
class OnInsert extends \Magento\Cms\Controller\Adminhtml\Wysiwyg\Images
{
    ...
    {
        $helper = $this->_objectManager->get('CleverSoft\CleverPinMarker\Helper\Wysiwyg\Images');
