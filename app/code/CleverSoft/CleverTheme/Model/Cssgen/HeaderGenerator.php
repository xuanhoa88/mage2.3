...
class HeaderGenerator extends \Magento\Framework\Model\AbstractModel{
     ...
     * @var Data
     */
    protected $_helperHeaderCssgen = null;
    ...
    public function __construct(
        ...
        \CleverSoft\CleverTheme\Helper\HeaderCssgen $helperHeaderCssgen,
        ...
        $this->_helperHeaderCssgen = $helperHeaderCssgen;
    ...
    public function generateCss($storeCode)
    {
        ...
        $prefix = '_' . $storeCode;
        $design = "clever_headerbuilder_style";
        ...
        $filedefault = $this->_helperHeaderCssgen->getGeneratedCssDir() . $filename;
        ...
        try{
            ...
            if(!$this->_file->isExists($this->_helperHeaderCssgen->getGeneratedCssDir())){
                $this->_file->createDirectory($this->_helperHeaderCssgen->getGeneratedCssDir(),DriverInterface::WRITEABLE_DIRECTORY_MODE);
            }
            ...
            $this->messageManager->addError(__('Failed generating CSS file: '.$filename.' in ' . $this->_helperHeaderCssgen->getGeneratedCssDir() ). '<br/>Message: ' . $gener->getMessage());
