...
namespace CleverSoft\CleverTheme\Controller\Product;
...
class View extends \Magento\Catalog\Controller\Product
{
    ...
    public function execute()
    {
        ...
        // Render page
        try {
            $page = $this->resultPageFactory->create(false, ['isIsolated' => true, 'template'=>'CleverSoft_CleverTheme::quickview/blank.phtml'] );
