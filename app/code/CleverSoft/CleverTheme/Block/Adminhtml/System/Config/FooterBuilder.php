...
class FooterBuilder extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    protected function _prepareLayout()
    {
        ...
        if (!$this->getTemplate()) {
            $this->setTemplate('system/config/footer_builder.phtml');
        }
        return $this;
    }
    ...
    public function getFooterDesktopData() {
        return $this->getFooterData()->getData('footer_desktop_data');
    }

    public function getFooterMobileData() {
        return $this->getFooterData()->getData('footer_mobile_data');
    }
