...
/***/ (function(module, exports, __webpack_require__) {
    ...
    function jarallaxVideo() {
        ...
        Jarallax.prototype.canInitParallax = function () {
            ...
            if (self.$item.getAttribute('data-auto-play') === "true" || self.$item.getAttribute('data-auto-play') === '1') {
                var auto_play = true;
            } else {
                var auto_play = false;
            }

            if (self.$item.getAttribute('data-video-loop') === "false" || self.$item.getAttribute('data-video-loop') === '0') {
                var auto_loop = false;
            } else {
                var auto_loop = true;
            }
            ...
            var video = new _videoWorker2.default(self.options.videoSrc, {
                ...
                volume: self.$item.getAttribute('data-video-volume') || 0
            });
