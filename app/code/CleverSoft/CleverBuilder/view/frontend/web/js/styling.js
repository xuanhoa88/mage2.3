...
define(['jquery',"jquery/ui"
    ...
    $( function (  ) {
        ...
        var stretchFullWidthRows = function () {
            ...
            $( '.cleversoft-panels-stretch.panel-row-style' ).each( function () {
                var $$ = $( this );
            ...
            if ( $( '.cleversoft-panels-stretch.panel-row-style' ).length ) {
        ...
        $( 'body' ).removeClass( 'cleversoft-panels-before-js' );
