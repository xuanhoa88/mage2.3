 ...
 */
namespace CleverSoft\CleverBuilder\Model\Wysiwyg;
...
class Config extends \Magento\Framework\DataObject implements ConfigInterface
{
     ...
     */
    const WYSIWYG_STATUS_CONFIG_PATH = 'cleverbuilder/wysiwyg/enabled';

    /**
     *
     */
    const WYSIWYG_SKIN_IMAGE_PLACEHOLDER_ID = 'CleverSoft_CleverBuilder::images/wysiwyg_skin_image.png';
    ...
    public function getConfig($data = [])
    {
        ...
        $config->setData(
            [
                ...
                'directives_url' => $this->_backendUrl->getUrl('cleverbuilder/wysiwyg/directive'),
        ...
        $config->addData(
            [
                'add_images' => true,
                'files_browser_window_url' => $this->_backendUrl->getUrl('cleverbuilder/wysiwyg_images/index'),
