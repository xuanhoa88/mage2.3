...
namespace CleverSoft\CleverBuilder\Block\System\Config\Form\Field;
    ...
    protected function _getInfo()
    {
        $html = '<div class="cleversoft-info-block">
            <div class="cleversoft-module-version">
                <div><span class="version-title">CleverBuilder <span class="module-version last-version">'.$this->moduleResource->getDbVersion('CleverSoft_CleverBuilder').'</span> by </span>
            ...
            <div class="cleversoft-user-guide">
                <span class="message success">Need help with the settings?  Please  consult the <a target="_blank" href="https://doc.cleveraddon.com/cleverbuilder">user guide</a> to configure the extension properly.</span></div>
        </div>';
