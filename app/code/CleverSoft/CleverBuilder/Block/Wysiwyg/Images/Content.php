...
class Content extends \Magento\Backend\Block\Widget\Container
{
    ...
    {
        return $this->getUrl('cleverbuilder/*/contents', ['type' => $this->getRequest()->getParam('type')]);
    }
    ...
    {
        return $this->getUrl('cleverbuilder/*/newFolder');
    }
    ...
    {
        return $this->getUrl('cleverbuilder/*/deleteFolder');
    }
    ...
    {
        return $this->getUrl('cleverbuilder/*/deleteFiles');
    }
    ...
    {
        return $this->getUrl('cleverbuilder/*/onInsert');
    }
