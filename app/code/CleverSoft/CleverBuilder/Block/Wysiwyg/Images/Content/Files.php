...
class Files extends \Magento\Backend\Block\Template
{
     ...
     * @param \CleverSoft\CleverBuilder\Model\Wysiwyg\Images\Storage $imageStorage
     * @param \CleverSoft\CleverBuilder\Helper\Wysiwyg\Images $imageHelper
     * @param array $data
     */
    public function __construct(
        \Magento\Backend\Block\Template\Context $context,
        \CleverSoft\CleverBuilder\Model\Wysiwyg\Images\Storage $imageStorage,
        \CleverSoft\CleverBuilder\Helper\Wysiwyg\Images $imageHelper,
        array $data = []
    ) {
