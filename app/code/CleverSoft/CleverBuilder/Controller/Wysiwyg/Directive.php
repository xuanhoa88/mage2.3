...
class Directive extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $imagePath = $this->_objectManager->create(\CleverSoft\CleverBuilder\Model\Template\Filter::class)->filter($directive);
        ...
        try {
            ...
            $imagePath = $this->_objectManager->get(
                \CleverSoft\CleverBuilder\Model\Wysiwyg\Config::class
