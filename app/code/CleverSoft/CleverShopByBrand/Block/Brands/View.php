 ...
 * @since 100.0.2
 */
class View extends \Magento\Catalog\Block\Product\AbstractProduct implements IdentityInterface
{
    /**
    ...
    protected function _prepareLayout()
    {
        ...
        if ($brand) {
            ...
            $metaTitle = $brand->getMetaTitle()?:$title;
            $this->pageConfig->getTitle()->set($metaTitle);

            $description = $brand->getMetaDescription()?:$brand->getDescription();
            if ($description) {
                $this->pageConfig->setDescription($description);
            }
            $keywords = $brand->getMetaKeyword();
            if ($keywords) {
                $this->pageConfig->setKeywords($keywords);
            }

            /* facebook meta tag */
            $this->pageConfig->setMetadata('og:url', $this->getBrandPageUrl($brand));
            ...
            $this->pageConfig->setMetadata('og:image', $brand->getLogo());
    ...
    private function initializeProductCollection()
    {
        ...
        $collection = $layer->getProductCollection()->addAttributeToFilter($assignAttributeCode,$this->getBrand()->getId());
        ...
        $this->_eventManager->dispatch(
            'brand_catalog_block_product_list_collection',
