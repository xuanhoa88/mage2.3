...
class Image extends \CleverSoft\CleverShopByBrand\Block\Adminhtml\CleverShopByBrand\AbstractHtmlField
{
    /**
    ...
    public function getHintHtml()
    {
		...
		if( !empty( $element->getValue() ) ){
			...
			$imageUrl = $this->assetRepo->getUrl('CleverSoft_CleverShopByBrand/images/placeholder_thumbnail.jpg');	
		}
		...
		$html = $this->_getButtonHtml(
			[
				...
				'onclick' => "CleverMediabrowserUtility.openDialog(this, '" . $this->getUrl('shopbybrand/wysiwyg_images',
