...
define(['jquery', 'jqueryAutocomplete','owlCarousel'], function($, domReady, owlCarousel) {
    ...
    $.widget('brand.slider', {
        ...
        _create: function() {
            ...
            self.element.removeClass('lazy-loading');
            self._lazyImage();
            ...
            self.element.find('.owl-carousel').owlCarousel(conf);
        },
        _lazyImage: function() {
            var self = this, conf = this.options;
