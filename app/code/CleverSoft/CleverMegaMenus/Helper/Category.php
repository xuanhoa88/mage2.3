...
class Category extends AbstractHelper
{
	...
	public function getCatsByParentId($parent_id, $sorted = false, $asCollection = false, $toLoad = true)
    {
        $cacheKey = sprintf('%d-%d-%d-%d', $parent_id, $sorted, $asCollection, $toLoad);
        if (isset($this->_storeCategories[$cacheKey])) {
            return $this->_storeCategories[$cacheKey];
        }
        ...
        $storeCategories = $category->getCategories($parent_id, $recursionLevel, $sorted, $asCollection, $toLoad);
