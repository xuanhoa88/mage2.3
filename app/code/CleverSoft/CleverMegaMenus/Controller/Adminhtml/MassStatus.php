...
namespace CleverSoft\CleverMegaMenus\Controller\Adminhtml;
...
class MassStatus extends \Magento\Backend\App\Action
{
	...
	public function execute()
    {
        ...
        /*
         * https://github.com/Turiknox/magento2-sample-uicomponent/blob/master/app/code/Turiknox/Sample/Controller/Adminhtml/Data/MassAction.php
         *
         */
        try {
            if (isset($excluded)) {
