...
define([
    ...
    return Component.extend({
        ...
        initialize: function () {
            ...
            $('#top_sidetree_mobile a').click(function() {
                var self = this;
                var searchText = $("#search_mobile").val();
                var searchCat = $('#cat-search-mobile').val();
                if (searchText.length && searchText.length < self.minSearchLength) {
                    return false;
                }

                registry.get('cleversearchautocompleteDataProviderMobile', function (dataProvider) {
        ...
        showPopup: function (event) {
            ...
            registry.get('cleversearchautocomplete_form_mobile', function (autocomplete) {
