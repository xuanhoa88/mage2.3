...
return [
    'modules' => [
        ...
        'Amazon_Payment' => 1,
        'CleverSoft_Base' => 1,
        'CleverSoft_CleverBuilder' => 1,
        'CleverSoft_CleverCookieLaw' => 1,
        'CleverSoft_CleverInstagram' => 1,
        'CleverSoft_CleverLayeredNavigation' => 1,
        'CleverSoft_CleverMegaMenus' => 1,
        'CleverSoft_CleverPinMarker' => 1,
        'CleverSoft_CleverSearchAutoComplete' => 1,
        'CleverSoft_CleverShopByBrand' => 1,
        'CleverSoft_CleverSocialLogin' => 1,
        'CleverSoft_CleverSocialProof' => 1,
        'CleverSoft_CleverTheme' => 1,
